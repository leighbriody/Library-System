...
//    int userId , WE DO NOT INITALIZE THE USERID AS THAT SHOULD INCREMENT BY ITSELF
    public User(String firstName, String lastName, String email, String username, String password, String phone, String accessId, String userTypeId, int addressId) {
    ...
    public User(int userId, String fName, String lName, String email, String uName, String pWord, String phNumber) {
        this.userId = userId;
