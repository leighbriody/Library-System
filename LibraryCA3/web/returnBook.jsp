<%-- 
    Document   : returnBook
    Created on : 02-Jan-2021, 23:49:12
    ...
    <div class="container">
        ...
        <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
            <div class="col-md-6 px-0">
                <h1 class="display-4 font-italic">Return a Book</h1>
                <p class="lead my-3">Use this page to return a book.</p>
            </div>
        </div>
        <%
            //get user session
            ...
            if (u != null) {
                //create an accessor for the user's loans
                LoanDao lDao = new LoanDao("librarydb");
                //accessor for getting book names
                BookDao bDao = new BookDao("librarydb");
                //now to generate the list of active user loans
            ...
            <select name="bookId">
                <%
                    ...
                    for (Loan l : activeLoans) {
                        b = bDao.getBookById(l.getBookId());
                %>
                ...
                <input type="hidden" value="returnBook" name="action">
            </select>
        </form>
        <%
            } else {
