...
<html>
    <head>
        ...
        <title><%=dataBundle.getString("editUser_title")%></title>
        ...
        <div class="container">
            ...
            <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
                <div class="col-md-6 px-0">
                    <h1 class="display-4 font-italic"><%=dataBundle.getString("editUser_name")%></h1>
  ...
  <!--CHANGE USER DETAILS FORM -->
            <% //Check if user logged in is not equal to null
                ...
                if (loggedInUser != null) {
                    //here we will get the user to supply their new details to change
                    //we will already have them preset, and they will be changed by the user (for the details they wish to change)
                    //the only inputs without a preset value will be their username & password
            %>
            <div class="signup-form">
                <form action="FactoryServlet" method="post">
                  
                    <div class="form-group">
                        <h2>Username and password needed for changes  to take effect.</h2>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="firstName" placeholder="First Name"  value="<%= loggedInUser.getFirstName() %>" required="required">
                    </div>
                    <div class="form-group">
                        <span>Last Name :</span>
                        <input type="text" class="form-control" name="lastName" placeholder="Last Name" value="<%= loggedInUser.getLastName() %>" required="required">
                    </div>
                    <div class="form-group">
                        <span>Email :</span>
                        <input type="email" class="form-control" name="email" placeholder="Email" value="<%= loggedInUser.getEmail() %>" required="required">
                    </div>
                    <div class="form-group">
                        <span>Phone :</span>
                        <input type="text" class="form-control" name="phone" placeholder="Phone"  value="<%= loggedInUser.getPhone() %>" required="required">
                    </div>
